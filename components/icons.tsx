// lucide-react dropped brand/logo icons, so GitHub and LinkedIn marks are
// hand-rolled here as simple single-path SVGs (same prop shape as lucide
// icons: size + className) so they drop into the same call sites.
